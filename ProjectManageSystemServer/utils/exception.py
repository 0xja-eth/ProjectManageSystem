...
class ErrorType(Enum):
    ...
    NameFormate = 142  # 名字格式
    IncorrectGender = 143  # 性别
    IncorrectCity = 144  # 城市
    IncorrectEdu = 145  # 学历
    IncorrectDuty = 146  # 职务
    IncorrectConnact = 147  # 联系方式
    IncorrectDescription = 148  # 个人描述
    IncorrectAvatar = 149  # 头像错误
    # Friend
